...
export default function studentRegisterExtra({profile,handleChangeSelect,handleChangeProfile}){
    ...
    return(
        <div>
				...
				<div>
					...
					<MultiSelect
                        ...
                        >
						{
                            data?.goals.map((goal,index)=>(
                                <MultiSelectItem key={index} value={goal.value}>{goal.value}</MultiSelectItem>
                                ))
                            }
					</MultiSelect><br/>
                    ...
                    <p>Por ultimo, selecciona de los siguientes problemas, ¿cuales tienes presente como estudiante?</p>
					...
					<MultiSelect
                        ...
                        >
						{
                            data?.problematics.map((problematic,index)=>(
                                <MultiSelectItem key={index} value={problematic.value}>{problematic.value}</MultiSelectItem>
                                ))
                            }
					</MultiSelect><br/>
