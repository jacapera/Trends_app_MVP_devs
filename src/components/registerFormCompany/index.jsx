...
import CompanyRegisterAcademic from "./academicRegisterForm";
import CompanyRegisterInfo from "./infoRegisterForm";
...
export default function CompanyRegisterForm() {
  ...
  useEffect(
    () => {
      ...
      setIsAcademicComplete(
        validateAcademic(formCompany) && errorAcademic(error)
      );
    ...
    <div>
      ...
      <form onSubmit={submitHandler}>
        ...
        <div>
          <Button
            disabled={
              !(isContactComplete && isAcademicComplete && isInfoComplete)
            }
            type="submit"
